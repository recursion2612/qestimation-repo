...
int main(int argc, char* argv[])
{
	...
	cout<<"Stochastic Differential equation solver: Solving as a KET :-\n";
	...
	cx_mat s1 = (psi0.t()*sx*psi0);
	cx_mat s2 = (psi0.t()*sy*psi0);
	cx_mat s3 = (psi0.t()*sz*psi0);
	...
	for(int jj=0; jj<samples; jj++)
	{
		...
		// Dynamics
		cx_vec psit(2, fill::zeros); // dummy wf
	...
	ofstream Sigma_data("data_wf_col.txt");
